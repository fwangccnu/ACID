...
<div class="row">
    <div class="col-lg-12">
        <form action="<?php echo site_url(array('druggability','check'))?>" method="post" accept-charset="utf-8">
            <div class="row" style="margin-top: 20px">
                <div class="col-lg-6 col-md-12 col-xs-12 text-left">
                    <img src="<?php echo base_url(array('resource','img','logo_bg.png')); ?>" style="width: 553px;height: 258px;">
                </div>
                <div class="col-lg-6 col-md-12 col-xs-12 login-form">
                    <div class="panel  panel-default">
                        <div class="panel-body">
                            <h4 class="media-heading">ReverseDock Login</h4>
